...
export const PositiveReview: Story = {
  ...
  args: {
    ...
    initialRating: 4,
    initialReview:
      'Juda yaxshi noutbuk! Batareya uzoq chidaydi, ekrani ajoyib. Dasturlash uchun ideal mashina.',
  },
};
...
export const ExcellentReview: Story = {
  ...
  args: {
    ...
    initialRating: 5,
    initialReview:
      "Eng yaxshi naushnik! Shovqinni bekor qilish texnologiyasi ajoyib ishlaydi. Musiqa sifati ham a'lo darajada. 2 yil ishlatdim, hech qanday muammo bo'lmadi.",
  },
};
...
export const NegativeReview: Story = {
  ...
  args: {
    ...
    initialRating: 1,
    initialReview:
      "Sichqoncha 2 haftadan keyin ishlamay qoldi. Chap tugma ikki marta bosadi, scroll g'ildiragi shovqin chiqaradi. Sifat juda past.",
  },
};
...
export const AverageReview: Story = {
  ...
  args: {
    ...
    productImage:
      'https://images.unsplash.com/photo-1591488320449-011701bb6704?w=100&h=100&fit=crop',
    initialRating: 3,
    initialReview:
      'Ovoz sifati yaxshi, lekin quloqqa yaxshi turmaydi. ANC ishlaydi, ammo Sonyga qaraganda zaifroq. Narxiga mos, lekin ajoyib emas.',
  },
};
