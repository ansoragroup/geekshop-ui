    ...
    initialNotifications: [
      {
        ...
        message:
          'GS-2026032101 raqamli buyurtmangiz ombordan chiqdi. Kuzatish raqami: UZ1234567890',
      ...
      },
      {
        ...
        message:
          "GS-2026032005 buyurtma uchun 8,900,000 UZS to'lov muvaffaqiyatli amalga oshirildi.",
      ...
      },
      {
        ...
        message:
          "Sizning hisobingizga iPhone 15 Pro orqali kirildi. Bu siz bo'lmasangiz, parolni o'zgartiring.",
    ...
    initialNotifications: [
      {
        ...
        type: 'order' as const,
        title: "Buyurtma jo'natildi",
        message: 'GS-2026032301 buyurtmangiz ombordan chiqdi.',
      ...
      },
      {
        id: '2',
        type: 'promo' as const,
        title: 'Bahor aksiyasi boshlandi!',
        message: 'Barcha kiyim-kechaklarga 40% gacha chegirma.',
        timestamp: '1 soat oldin',
        read: false,
        avatarName: 'Aksiya',
        badgeColor: 'error' as const,
      },
      {
        ...
        message: "GS-2026032205 buyurtma uchun to'lov 24 soat ichida amalga oshirilishi kerak.",
        timestamp: '3 soat oldin',
        read: false,
        avatarName: "To'lov",
        badgeColor: 'warning' as const,
      },
      {
        ...
        message: 'Yangi yetkazib berish manzili muvaffaqiyatli saqlandi.',
        timestamp: '6 soat oldin',
        read: true,
        avatarName: 'Tizim',
        badgeColor: 'info' as const,
      },
      {
        ...
        message:
          "GS-2026031801 buyurtma bo'yicha qaytarish arizasi qabul qilindi. Pul 5-7 ish kuni ichida qaytariladi.",
        timestamp: '1 kun oldin',
        read: true,
        avatarName: 'Qaytarish',
        badgeColor: 'success' as const,
      },
      {
        id: '6',
        type: 'promo' as const,
        title: "Kupon sovg'a!",
        message: 'Sodiq mijozlarimiz uchun: LOYAL20 kodi bilan 20% chegirma',
        timestamp: '1 kun oldin',
        read: true,
        avatarName: "Sovg'a",
        badgeColor: 'primary' as const,
      },
      {
        ...
        type: 'order' as const,
        title: 'Buyurtma yetkazildi',
        message: 'GS-2026031501 raqamli buyurtmangiz yetkazildi.',
        timestamp: '2 kun oldin',
        read: true,
        avatarName: 'Buyurtma',
        badgeColor: 'success' as const,
      },
      {
        ...
        message: 'alisher@mail.uz elektron pochta muvaffaqiyatli tasdiqlandi.',
        timestamp: '3 kun oldin',
        read: true,
        avatarName: 'Tizim',
        badgeColor: 'info' as const,
      },
      {
        id: '9',
        type: 'promo' as const,
        title: 'Yangi RTX 5070 seriyasi!',
        message: 'NVIDIA RTX 5070 videokarta endi oldindan buyurtma qilish mumkin.',
        timestamp: '4 kun oldin',
        read: true,
        avatarName: 'Yangilik',
        badgeColor: 'primary' as const,
      },
      {
        ...
        message: "GS-2026031001 buyurtma sizning so'rovingiz bilan bekor qilindi.",
        timestamp: '5 kun oldin',
        read: true,
        avatarName: 'Buyurtma',
        badgeColor: 'error' as const,
      },
