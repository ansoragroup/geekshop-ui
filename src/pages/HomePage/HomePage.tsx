...
const deals = [
  ...
  {
    image: 'https://images.unsplash.com/photo-1555618568-bfe052310f39?w=240&h=240&fit=crop',
    title: 'Ryzen 7 5800X',
    price: 2100000,
...
const products: ProductCardFlatProps[] = [
  ...
  // Left col (standard height images):
  {
    ...
    title: 'MSI GeForce RTX 4070 Super 12GB GDDR6X',
    price: 8900000,
    soldCount: '234 dona sotilgan',
    badge: 'top',
  },
  // Right col (taller images):
  {
    image: 'https://images.unsplash.com/photo-1555618568-bfe052310f39?w=400&h=560&fit=crop',
    title: 'AMD Ryzen 9 7950X Protsessor 16 yadro',
    price: 5600000,
    soldCount: '189 dona sotilgan',
    badge: 'hot',
  },
  // Left:
  {
    image: 'https://images.unsplash.com/photo-1593640408182-31c70c8268f5?w=400&h=400&fit=crop',
    title: 'ASUS ROG Swift 27" 2K 165Hz Monitor',
    price: 4800000,
    soldCount: '156 dona sotilgan',
    badge: 'top',
  },
  // Right:
  {
  ...
  // Left:
  {
    ...
    price: 2800000,
    soldCount: '278 dona sotilgan',
    badge: 'top',
  },
  // Right:
  {
    image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&h=540&fit=crop',
    title: 'ASUS ROG Strix B650E-F Motherboard',
    price: 3400000,
    soldCount: '98 dona sotilgan',
  },
  // Left:
  {
    image: 'https://images.unsplash.com/photo-1550009158-9ebf69173e03?w=400&h=400&fit=crop',
    title: 'NZXT Kraken X63 RGB 280mm AIO Cooler',
    price: 1900000,
    soldCount: '145 dona sotilgan',
    badge: 'new',
  },
  // Right:
  {
    image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=400&h=500&fit=crop',
    title: 'Lian Li O11 Dynamic EVO RGB Case',
    price: 2400000,
    soldCount: '87 dona sotilgan',
  },
];
...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  return (
    <div className={styles.homePage}>
      ...
      {/* 2. NoticeBar */}
      <NoticeBar content={t('home.noticeNewUser')} mode="scroll" />
      ...
      <div className={styles.recommendedSection}>
        <SectionHeader title={t('home.recommended')} onViewAll={() => {}} />
        <div className={styles.tabFilterWrap}>
          <TabFilter tabs={filterTabs} activeTab={activeTab} onChange={setActiveTab} />
        </div>
        <ProductGrid products={products} layout={gridLayout} columns={2} gap={8} />
      </div>

      {/* 9. TabBar */}
      <TabBar activeKey={activeBarTab} onChange={setActiveBarTab} />
    </div>
  );
};
