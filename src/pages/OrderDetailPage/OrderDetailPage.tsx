    ...
    <div className={styles.page}>
      ...
      <Container hasNavbar>
        ...
        <div className={styles.statusHeader}>
          <Badge type="text" content={statusLabel} color={statusColor as 'info' | 'success' | 'warning'} position="inline" />
              ...
              {steps.map((step, i) => (
                <div key={i} className={styles.step}>
                  <div className={styles.stepIndicator}>
                    <div
                      className={`${styles.stepDot} ${step.completed ? styles.stepDotCompleted : ''} ${step.active ? styles.stepDotActive : ''}`}
                    />
                    {i < steps.length - 1 && (
                      <div className={`${styles.stepLine} ${step.completed ? styles.stepLineCompleted : ''}`} />
                    )}
                  </div>
