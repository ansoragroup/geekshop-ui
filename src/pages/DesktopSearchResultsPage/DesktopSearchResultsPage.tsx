...
const searchResults: DesktopProductGridItem[] = [
  {
    id: 's1',
    image: 'https://c1.neweggimages.com/ProductImageCompressAll1280/34-346-003-V01.jpg',
    title: 'Apple MacBook Air M3 15" 16GB RAM 512GB',
    price: 18900000,
  ...
  {
    id: 's2',
    image: 'https://c1.neweggimages.com/ProductImageCompressAll1280/20-147-874-V01.jpg',
  ...
  {
    id: 's3',
    image: 'https://c1.neweggimages.com/ProductImageCompressAll1280/14-126-678-V01.jpg',
  ...
  {
    id: 's4',
    image: 'https://c1.neweggimages.com/ProductImageCompressAll1280/26-106-967-V01.jpg',
  ...
  {
    id: 's5',
    image: 'https://c1.neweggimages.com/ProductImageCompressAll1280/23-816-215-V01.jpg',
  ...
  {
    id: 's6',
    image: 'https://c1.neweggimages.com/ProductImageCompressAll1280/24-260-907-V01.jpg',
  ...
  {
    id: 's8',
    image: 'https://c1.neweggimages.com/ProductImageCompressAll1280/26-153-388-V01.jpg',
    title: 'Razer DeathAdder V3 HyperSpeed Wireless',
    price: 1200000,
    rating: 4.5,
    reviewCount: 1567,
    freeShipping: false,
  ...
  {
    id: 's9',
    image: 'https://c1.neweggimages.com/ProductImageCompressAll1280/AAFBS2209230001IY3G205.jpg',
  ...
  {
    id: 's10',
    image: 'https://c1.neweggimages.com/ProductImageCompressAll1280/36-785-024-V01.jpg',
  ...
  return (
    <DesktopShell topBar={<DefaultTopBar />} header={header} footer={<DefaultFooter />}>
      <div className={styles.breadcrumbs}>
        <DesktopBreadcrumbs
          items={[{ label: 'Home', href: '#' }, { label: `Search: "${searchValue}"` }]}
        />
      </div>
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.resultsColumn}>
          ...
          {loading ? (
            ...
            <>
              <DesktopProductGrid products={displayResults} columns={4} viewMode="grid" />
