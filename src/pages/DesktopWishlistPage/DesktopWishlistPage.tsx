...
export const DesktopWishlistPage: React.FC<DesktopWishlistPageProps> = ({ initialProducts }) => {
  ...
  return (
    <DesktopShell topBar={<DefaultTopBar />} header={header} footer={<DefaultFooter />}>
      <div className={styles.breadcrumbs}>
        <DesktopBreadcrumbs items={[{ label: 'Home', href: '#' }, { label: 'My Wishlist' }]} />
      </div>
      ...
      <div className={styles.content}>
        {items.length === 0 ? (
          ...
          <DesktopProductGrid products={items} columns={5} viewMode="grid" />
        )}
      </div>
    </DesktopShell>
  );
