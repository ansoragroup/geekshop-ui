...
// Demo: flash deals end 4 hours from page load (module-level to satisfy react-compiler purity)
const flashDealsEndTime = new Date(Date.now() + 4 * 60 * 60 * 1000);
      ...
      <section className={styles.section}>
        <div className={styles.flashHeader}>
          ...
          <div className={styles.flashTimer}>
            ...
            <DesktopCountdownTimer endTime={flashDealsEndTime} />
          </div>
        </div>
        <DesktopProductGrid
