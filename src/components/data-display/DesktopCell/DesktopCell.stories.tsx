...
const BellIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path d="M10 2a5 5 0 00-5 5v3l-1.5 2h13L15 10V7a5 5 0 00-5-5zM8.5 17h3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const CellList: Story = {
  ...
  render: () => (
    <div style={{ background: '#fff', borderRadius: 12, overflow: 'hidden' }}>
      <DesktopCell title="Account" description="Manage your account settings" icon={<UserIcon />} showArrow border onClick={() => {}} />
      <DesktopCell title="Settings" description="App preferences and configuration" icon={<SettingsIcon />} showArrow border onClick={() => {}} />
      <DesktopCell title="Security" description="Password, 2FA, and login history" icon={<ShieldIcon />} value="Enabled" showArrow border onClick={() => {}} />
      <DesktopCell title="Notifications" description="Push and email notification preferences" icon={<BellIcon />} value="3 new" showArrow border onClick={() => {}} />
      <DesktopCell title="Payment Methods" description="Manage cards and wallets" icon={<WalletIcon />} showArrow onClick={() => {}} />
    </div>
  ),
};
...
export const OrderDetailCells: Story = {
  ...
  render: () => (
    <div style={{ background: '#fff', borderRadius: 12, overflow: 'hidden' }}>
      ...
      <DesktopCell title="Total Amount" value={<span style={{ color: '#FF0000', fontWeight: 600 }}>23,700,000 UZS</span>} />
    </div>
  ),
};
...
export const LongDescription: Story = {
  ...
  args: {
    ...
    description: 'Control who can see your profile, order history, reviews, and wishlist. You can also manage your data sharing preferences with third-party partners.',
    icon: <ShieldIcon />,
    showArrow: true,
  },
};
...
export const ReactNodeValue: Story = {
  ...
  args: {
    title: 'Status',
    value: (
      <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, color: '#07C160', fontSize: 13, fontWeight: 500 }}>
