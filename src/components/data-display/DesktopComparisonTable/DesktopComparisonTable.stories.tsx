...
import {
  ...
  type DesktopComparisonProduct,
  type DesktopComparisonSpec,
...
const gpuProducts: DesktopComparisonProduct[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1555618568-bfe052310f39?w=200&h=200&fit=crop',
    price: 7_100_000,
  },
];
    ...
    specs: [
      {
        key: 'display',
        label: 'Display Size',
        values: { s24: '6.8"', ip16: '6.9"', x14: '6.73"' },
      },
      {
        key: 'chip',
        label: 'Chipset',
        values: { s24: 'Snapdragon 8 Gen 3', ip16: 'A18 Pro', x14: 'Snapdragon 8 Gen 3' },
      },
      {
        key: 'ram',
        label: 'RAM',
        values: { s24: 12, ip16: 8, x14: 16 },
        unit: 'GB',
        higherIsBetter: true,
      },
      {
        key: 'storage',
        label: 'Base Storage',
        values: { s24: 256, ip16: 256, x14: 256 },
        unit: 'GB',
      },
      {
        key: 'main_cam',
        label: 'Main Camera',
        values: { s24: 200, ip16: 48, x14: 50 },
        unit: 'MP',
        higherIsBetter: true,
      },
      {
        key: 'battery',
        label: 'Battery',
        values: { s24: 5000, ip16: 4685, x14: 5300 },
        unit: 'mAh',
        higherIsBetter: true,
      },
      {
      ...
      },
      {
        key: 'weight',
        label: 'Weight',
        values: { s24: 232, ip16: 227, x14: 220 },
        unit: 'g',
        higherIsBetter: false,
      },
      ...
      { key: 'spen', label: 'Stylus Support', values: { s24: true, ip16: false, x14: false } },
      {
        ...
        values: { s24: 'Android 14', ip16: 'iOS 18', x14: 'Android 14' },
      },
    ],
    highlightDifferences: true,
  },
  ...
  args: {
    ...
    specs: [
      ...
      },
      {
        key: 'display',
        label: 'Display',
        values: { rog: '16" QHD 240Hz', xps: '15.6" OLED 60Hz' },
      },
      {
        key: 'weight',
        label: 'Weight',
        values: { rog: 2.5, xps: 1.86 },
        unit: 'kg',
        higherIsBetter: false,
      },
      {
  ...
  args: {
    ...
    specs: [
      { key: 'size', label: 'Screen Size', values: { m1: '27"', m2: '27"', m3: '27"', m4: '28"' } },
      {
        key: 'res',
        label: 'Resolution',
        values: { m1: '2560x1440', m2: '2560x1440', m3: '2560x1440', m4: '3840x2160' },
      },
      {
        key: 'refresh',
        label: 'Refresh Rate',
        values: { m1: 165, m2: 240, m3: 165, m4: 144 },
        unit: 'Hz',
        higherIsBetter: true,
      },
      {
        key: 'panel',
        label: 'Panel Type',
        values: { m1: 'Nano IPS', m2: 'VA', m3: 'VA', m4: 'IPS' },
      },
      {
        key: 'response',
        label: 'Response Time',
        values: { m1: 1, m2: 1, m3: 1, m4: 1 },
        unit: 'ms',
        higherIsBetter: false,
      },
      {
        key: 'hdr',
        label: 'HDR',
        values: { m1: 'HDR 400', m2: 'HDR 600', m3: 'HDR 400', m4: 'HDR 400' },
      },
      { key: 'curved', label: 'Curved', values: { m1: false, m2: true, m3: true, m4: false } },
      {
        key: 'gsync',
        label: 'G-Sync Compatible',
        values: { m1: true, m2: true, m3: true, m4: true },
      },
    ],
    highlightDifferences: true,
  },
    ...
    specs: [
      {
        key: 'free_delivery',
        label: 'Free Delivery',
        values: { basic: false, plus: true, pro: true },
      },
      {
        key: 'priority',
        label: 'Priority Support',
        values: { basic: false, plus: false, pro: true },
      },
      {
        key: 'returns',
        label: 'Extended Returns (30 days)',
        values: { basic: false, plus: true, pro: true },
      },
      {
        key: 'exclusive',
    ...
    const specs: DesktopComparisonSpec[] = [
      {
        ...
        values: { tv1: 'Neo QLED', tv2: 'OLED', tv3: 'OLED' },
      },
      { key: 'res', label: 'Resolution', values: { tv1: '4K', tv2: '4K', tv3: '4K' } },
      {
        key: 'refresh',
        label: 'Refresh Rate',
        values: { tv1: 120, tv2: 120, tv3: 120 },
        unit: 'Hz',
      },
      {
        key: 'hdr',
        label: 'HDR Format',
        values: { tv1: 'HDR10+', tv2: 'Dolby Vision', tv3: 'Dolby Vision' },
      },
      {
        key: 'smart',
        label: 'Smart Platform',
        values: { tv1: 'Tizen', tv2: 'webOS', tv3: 'Google TV' },
      },
      {
        key: 'hdmi',
        label: 'HDMI 2.1 Ports',
        values: { tv1: 4, tv2: 4, tv3: 2 },
        higherIsBetter: true,
      },
      {
        key: 'speakers',
        label: 'Speaker Output',
        values: { tv1: 60, tv2: 40, tv3: 50 },
        unit: 'W',
        higherIsBetter: true,
      },
    ];
