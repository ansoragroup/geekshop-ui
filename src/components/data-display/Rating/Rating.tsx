...
function StarIcon({ size, fill, clipId }: { size: number; fill: 'full' | 'half' | 'empty'; clipId: string }) {
  if (fill === 'full') {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="var(--gs-color-star-filled, #FFC107)" stroke="none">
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="var(--gs-color-star-empty, #E0E0E0)" stroke="none">
      <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
    </svg>
  );
}
