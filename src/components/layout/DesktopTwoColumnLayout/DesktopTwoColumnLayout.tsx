...
import styles from './DesktopTwoColumnLayout.module.scss';

export interface DesktopTwoColumnLayoutProps extends HTMLAttributes<HTMLDivElement> {
  /** Sidebar content */
  sidebar: ReactNode;
...
export const DesktopTwoColumnLayout = forwardRef<HTMLDivElement, DesktopTwoColumnLayoutProps>(
  (
    {
      sidebar,
      sidebarWidth = 240,
    ...
    const rootClass = cn(styles.root, sidebarPosition === 'right' && styles.reversed, className);
...
DesktopTwoColumnLayout.displayName = 'DesktopTwoColumnLayout';
