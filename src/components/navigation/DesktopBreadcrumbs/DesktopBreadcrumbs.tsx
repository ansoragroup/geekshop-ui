...
import styles from './DesktopBreadcrumbs.module.scss';
...
export interface DesktopBreadcrumbsProps extends HTMLAttributes<HTMLElement> {
...
export const DesktopBreadcrumbs = forwardRef<HTMLElement, DesktopBreadcrumbsProps>(
            ...
            return (
              <li key={index} className={styles.item}>
                ...
                {isLast ? (
                  ...
                  <button className={styles.linkButton} onClick={item.onClick} type="button">
                    {item.label}
                  </button>
                ) : (
