        ...
        <div className={styles.mainRow}>
          ...
          {hasCategories ? (
            ...
            <button
              ...
              aria-label={l(labels, 'catalog')}
            >
              <GridIcon />
              <span>{l(labels, 'catalog')}</span>
            </button>
          )}
          ...
          {customActions ? (
            ...
            <nav className={styles.actions} aria-label={l(labels, 'userActions')}>
              <button
                ...
                aria-label={l(labels, 'orders')}
              >
                <PackageIcon />
                <span className={styles.actionLabel}>{l(labels, 'orders')}</span>
              </button>
              <button
                type="button"
                className={styles.actionBtn}
              ...
              >
                <CartIconSvg />
                <span className={styles.actionLabel}>{l(labels, 'cart')}</span>
              ...
              <button
                ...
                className={styles.actionBtn}
                onClick={onUserClick}
                aria-label={l(labels, 'signIn')}
              >
                <UserIcon />
                <span className={styles.actionLabel}>{l(labels, 'signIn')}</span>
              </button>
            </nav>
          )}
        </div>
            ...
            <div className={styles.promoLeft}>
              {promoTags.map((tag, idx) => (
                <button
                  ...
                  style={{
                    background: tag.bgColor || 'var(--gs-color-sale)',
                    color: tag.textColor || 'var(--gs-text-white)',
                  }}
                  onClick={tag.onClick}
                >
                  {tag.label}
