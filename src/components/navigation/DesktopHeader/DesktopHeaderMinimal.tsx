...
export interface DesktopHeaderMinimalProps extends HTMLAttributes<HTMLElement> {
  /** Logo content */
  logo?: ReactNode;
  /** Search placeholder */
...
export const DesktopHeaderMinimal = forwardRef<HTMLElement, DesktopHeaderMinimalProps>(
  (
    {
      logo,
  ...
  const { t } = useGeekShop();
    ...
    const scrollCategories = useCallback((direction: 'left' | 'right') => {
      const el = document.getElementById('minimal-cat-scroll');
      if (el) {
...
DesktopHeaderMinimal.displayName = 'DesktopHeaderMinimal';
