  ...
  args: {
    categories: [
      ...fullCategories,
      {
        ...
        icon: <GamepadIcon />,
        subcategories: [{ label: 'Running Shoes' }, { label: 'Camping Gear' }, { label: 'Cycling' }],
      },
      {
        label: 'Automotive',
        icon: <WrenchIcon />,
        subcategories: [{ label: 'Car Electronics' }, { label: 'Tires' }, { label: 'Interior Accessories' }],
      },
      {
        label: 'Health & Beauty',
        icon: <HeadphonesIcon />,
        subcategories: [{ label: 'Skincare' }, { label: 'Supplements' }, { label: 'Personal Care' }],
      },
    ],
    navItems: [
      { label: 'Flash Sale' },
  ...
  args: {
    categories: fullCategories.slice(0, 4).map((cat) => ({
      ...
      subcategories: cat.subcategories?.map((sub) => ({
        ...sub,
        href: `/category/${cat.label.toLowerCase().replace(/\s+/g, '-')}/${sub.label.toLowerCase().replace(/\s+/g, '-')}`,
      })),
    })),
  },
};
