...
import styles from './CategorySidebarLegacy.module.scss';

export interface CategoryItemLegacy {
  key: string;
  label: string;
  icon: ReactNode;
}

export interface CategorySidebarLegacyProps extends HTMLAttributes<HTMLDivElement> {
  /** Currently active category key */
  activeKey: string;
  /** Callback when a category is selected */
  onChange: (key: string) => void;
  /** Custom categories (defaults to GeekShop categories) */
  items?: CategoryItemLegacy[];
}
...
const DEFAULT_CATEGORIES: CategoryItemLegacy[] = [
...
export const CategorySidebarLegacy = forwardRef<HTMLDivElement, CategorySidebarLegacyProps>(
...
CategorySidebarLegacy.displayName = 'CategorySidebarLegacy';
