...
import styles from './DesktopPagination.module.scss';

export interface DesktopPaginationProps extends HTMLAttributes<HTMLElement> {
...
export const DesktopPagination = forwardRef<HTMLElement, DesktopPaginationProps>(
  (
    {
      currentPage,
      totalPages,
