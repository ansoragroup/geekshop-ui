...
export const Default: Story = {
  render: () => (
    <ModalStory title="Edit Product" footer={(onClose) => <FooterButtons onClose={onClose} />}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        <div>
          ...
          <input
            id="dm-name"
            type="text"
            defaultValue="MSI RTX 4060 Ventus 2X"
            style={{
              width: '100%',
              padding: '10px 12px',
              borderRadius: 8,
        ...
        <div>
          ...
          <textarea
            id="dm-desc"
            rows={4}
            defaultValue="High-performance graphics card with dual-fan cooling system for gaming and creative workloads."
            style={{
              width: '100%',
              padding: '10px 12px',
              borderRadius: 8,
  ...
  render: () => (
    ...
    >
      <div style={{ fontSize: 14, lineHeight: 1.7, color: '#666' }}>
        <p>
          By using GeekShop services, you agree to the following terms and conditions. Please read
          them carefully before proceeding.
        </p>
        <p>
          1. All products purchased through GeekShop are subject to our return policy. Returns must
          be initiated within 14 days of delivery.
        </p>
        <p>
          2. Prices are listed in Uzbekistani So'm (UZS) and include all applicable taxes. Shipping
          costs are calculated at checkout.
        </p>
        <p>
          3. Personal data collected during registration is processed in accordance with our Privacy
          Policy.
        </p>
      </div>
    </ModalStory>
      ...
      <div style={{ display: 'flex', gap: 20 }}>
        ...
        <div>
          ...
          <p style={{ margin: '0 0 4px', fontSize: 14, color: '#666' }}>
            8GB GDDR6 | 2460 MHz Boost | 115W TDP
          </p>
          <p style={{ margin: '0 0 12px', fontSize: 20, fontWeight: 700, color: '#FF0000' }}>
            12,500,000 UZS
          </p>
          <p style={{ margin: 0, fontSize: 13, color: '#07C160', fontWeight: 500 }}>
            In Stock (24 units)
          </p>
        </div>
      </div>
        ...
        <DesktopModal open={open} onClose={() => setOpen(false)}>
          <div style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            <p style={{ margin: 0, color: '#666', fontSize: 14 }}>
              MSI RTX 4060 has been added to your shopping cart.
            </p>
          </div>
        </DesktopModal>
      </div>
  ...
  render: () => (
    ...
    >
      <p style={{ margin: 0, fontSize: 14, color: '#666', lineHeight: 1.6 }}>
        Are you sure you want to delete your review of "MSI RTX 4060 Ventus 2X"? This action cannot
        be undone.
      </p>
    </ModalStory>
  ),
    ...
    >
      <div style={{ fontSize: 14, lineHeight: 1.7, color: '#666' }}>
        ...
        <p style={{ margin: '0 0 16px' }}>
          ...
          make a purchase, contact customer support, or participate in promotions. This includes
        ...
        <p style={{ margin: '0 0 16px' }}>
          We use the information we collect to process orders, provide customer support, send
          promotional communications, improve our services, and personalize your shopping
          experience.
        </p>
        <h4 style={{ color: '#333', margin: '0 0 8px' }}>3. Information Sharing</h4>
        <p style={{ margin: '0 0 16px' }}>
          We do not sell your personal information. We share information with delivery partners to
          fulfill your orders, payment processors to handle transactions, and service providers who
          assist in our operations.
        </p>
        <h4 style={{ color: '#333', margin: '0 0 8px' }}>4. Data Security</h4>
        <p style={{ margin: '0 0 16px' }}>
          We implement industry-standard security measures to protect your personal information,
          including encryption of sensitive data, secure server infrastructure, and regular security
          audits.
        </p>
        ...
        <p style={{ margin: '0 0 16px' }}>
          ...
          can manage your data through your account settings or by contacting our support team.
        </p>
        <h4 style={{ color: '#333', margin: '0 0 8px' }}>6. Cookies and Tracking</h4>
        <p style={{ margin: 0 }}>
          We use cookies and similar tracking technologies to enhance your browsing experience,
          analyze site traffic, and personalize content. You can manage your cookie preferences in
          ...
          {step === 1 && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div>
                ...
                <div id="dm-rating" style={{ display: 'flex', gap: 8 }}>
                  {[1, 2, 3, 4, 5].map((star) => (
                    <span
                      key={star}
                      style={{
                        fontSize: 28,
                        color: star <= 4 ? '#FFA726' : '#ddd',
                        cursor: 'pointer',
                      }}
                    >
                      &#9733;
    ...
    >
      <div style={{ textAlign: 'center', padding: '24px 0' }}>
        ...
        <p style={{ margin: 0, fontSize: 14, color: '#666' }}>
          NVIDIA GeForce RTX 4090 has been added to your cart. You now have 3 items totaling
          38,290,000 UZS.
        </p>
      </div>
    </ModalStory>
        ...
        >
          <div style={{ textAlign: 'center' }}>
            <p style={{ margin: '0 0 16px', fontSize: 14, color: '#666' }}>
              We sent a 6-digit verification code to <strong>a***z@gmail.com</strong>. Enter it
