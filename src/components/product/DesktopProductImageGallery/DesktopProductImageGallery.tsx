...
export const DesktopProductImageGallery = forwardRef<
  HTMLDivElement,
  DesktopProductImageGalleryProps
>(({ images, currentIndex, onIndexChange, zoomScale = 2, className = '', ...rest }, ref) => {
  const { t } = useGeekShop();
    ...
    <div ref={ref} className={cn(styles.root, className)} {...rest}>
      ...
      >
        <img
          ...
          alt={`${activeIndex + 1} of ${safeImages.length}`}
