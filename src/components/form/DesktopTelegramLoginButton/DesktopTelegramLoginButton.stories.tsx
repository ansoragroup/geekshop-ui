...
const meta = {
  title: 'Form (Desktop)/DesktopTelegramLoginButton',
    ...
    >
      ...
      >
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
          ...
          />
          <path
            d="M9 18c2.4 0 4.5-.8 6-2.2l-2.9-2.2c-.8.5-1.9.9-3.1.9-2.4 0-4.4-1.6-5.1-3.8H.9v2.3C2.4 15.9 5.5 18 9 18z"
            fill="#34A853"
          />
          <path
            d="M3.9 10.7c-.2-.5-.3-1.1-.3-1.7s.1-1.2.3-1.7V5H.9A9 9 0 000 9c0 1.5.3 2.8.9 4l3-2.3z"
            fill="#FBBC05"
          />
          <path
            d="M9 3.6c1.3 0 2.5.5 3.4 1.4l2.6-2.6C13.5.9 11.4 0 9 0 5.5 0 2.4 2.1.9 5l3 2.3C4.6 5.2 6.6 3.6 9 3.6z"
            fill="#EA4335"
          />
        </svg>
