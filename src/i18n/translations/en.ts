...
export const en: TranslationDictionary = {
  ...
  'product.imageSearch': 'Search by image',
  'product.imageSearchUrl': 'Paste image URL',
  'product.imageSearchDrop': 'or drag and drop an image here',
  'product.imageSearchBtn': 'Search',
  ...
  'aria.search': 'Search',
  'aria.searchProducts': 'Search products',
  'aria.submitSearch': 'Submit search',
  'aria.searchCategory': 'Search category',
  'aria.searchOptions': 'Search options',
  'aria.searchSuggestions': 'Search suggestions',
  'aria.clearSearch': 'Clear search',
  'aria.imageSearch': 'Search by image',
  'aria.closeImageSearch': 'Close image search',
  'aria.imageDropZone': 'Drop zone for image upload',
  'aria.clearInput': 'Clear input',
  'aria.shoppingCart': 'Shopping cart',
  'aria.openCatalog': 'Open catalog',
  'aria.orders': 'Orders',
  'aria.userAccount': 'User account',
  'aria.userActions': 'User actions',
  ...
  'aria.bannerCarousel': 'Banner carousel',
  'aria.scrollLeft': 'Scroll left',
  'aria.scrollRight': 'Scroll right',
  'aria.scrollCategoriesLeft': 'Scroll categories left',
  'aria.scrollCategoriesRight': 'Scroll categories right',
  'aria.decreaseQuantity': 'Decrease quantity',
  'aria.increaseQuantity': 'Increase quantity',
  'aria.quantity': 'Quantity',
  'aria.selectVariant': 'Select variant',
  'aria.remove': 'Remove',
  'aria.removeTag': 'Remove tag',
  'aria.addToWishlist': 'Add to wishlist',
  'aria.addToCart': 'Add to cart',
  'aria.buyAlone': 'Buy alone',
  'aria.chatWithShop': 'Chat with shop',
  'aria.enterShop': 'Enter shop',
  'aria.copyTrackingNumber': 'Copy tracking number',
  'aria.trackDelivery': 'Track delivery',
  'aria.uploadImages': 'Upload images',
  'aria.addMoreImages': 'Add more images',
  'aria.filters': 'Filters',
  'aria.filterTabs': 'Filter tabs',
  'aria.filterByRating': 'Filter by rating',
  'aria.minimumPrice': 'Minimum price',
  'aria.maximumPrice': 'Maximum price',
  'aria.breadcrumb': 'Breadcrumb',
  'aria.language': 'Language',
  'aria.selectLanguage': 'Select language',
  'aria.currency': 'Currency',
  'aria.selectCurrency': 'Select currency',
  'aria.themeMode': 'Theme mode',
  'aria.selectTheme': 'Select theme',
  'aria.themePreset': 'Theme preset',
  'aria.comparisonTable': 'Comparison table',
  'aria.productComparisonTable': 'Product comparison table',
  'aria.orderProducts': 'Order products',
  'aria.orderProgress': 'Order progress',
  'aria.reviewImages': 'Review images',
  'aria.progressSteps': 'Progress steps',
  'aria.timeline': 'Timeline',
  'aria.promotions': 'Promotions',
  'aria.categoryNavigation': 'Category navigation',
  'aria.categories': 'Categories',
  'aria.categoryFilter': 'Category filter',
  'aria.utilityNavigation': 'Utility navigation',
  'aria.quickActions': 'Quick actions',
  'aria.customerSupport': 'Customer support',
  'aria.flashDealCountdown': 'Flash deal countdown',
  'aria.emailNewsletter': 'Email address for newsletter',
  'aria.viewMode': 'View mode',
  'aria.gridView': 'Grid view',
  'aria.listView': 'List view',
  'aria.gridColumns': 'Grid columns',
  'aria.fourColumns': '4 columns',
  'aria.fiveColumns': '5 columns',
  'aria.productThumbnails': 'Product image thumbnails',
};
